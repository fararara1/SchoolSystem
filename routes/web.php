...
// Route API pour récupérer les évaluations d’un groupe (AJAX)

Route::resource('groups', GroupController::class);
    Route::resource('grades', GradeController::class)->only(['store']);
  // Notes - Sélection du groupe
  Route::prefix('classes/{classe}/evaluations/{evaluation}/notes')->group(function () {
    Route::get('/create', [NoteController::class, 'create'])->name('notes.create');
    Route::post('/', [NoteController::class, 'store'])->name('notes.store');
    Route::get('/result', [NoteController::class, 'result'])->name('notes.result');
});
