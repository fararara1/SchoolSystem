...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        if ($user->hasRole('Admin')) {
            ...
            $niveaux = Niveau::latest()->get();  // Récupération des niveaux

            return view('home', compact('parents', 'teachers', 'students', 'subjects', 'classes', 'niveaux'));  // Passer $niveaux à la vue
            ...
            $student = Student::with(['user', 'parent', 'classe', 'attendances'])->findOrFail($user->student->id);
